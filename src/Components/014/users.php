...
<body>
    ...
    <ul>
        ...
        <li>
            ...
            <a href="http://localhost/Chupakabra/my-app/src/Components/014/edit.php?id=<?= $user['user_id'] ?>">EDIT</a>
            <form action="http://localhost/Chupakabra/my-app/src/Components/014/delete.php?id=<?= $user['user_id'] ?>" method="post">
