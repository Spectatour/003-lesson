...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach($users as $user) {
        if ($user['place_in_row'] == (int) $_POST['place_in_row']) {
            ...
            header('Location: http://localhost/Chupakabra/my-app/src/Components/014/edit.php?id='.$id);
            die;
        }
    }
    ...
    header('Location: http://localhost/Chupakabra/my-app/src/Components/014/users.php?sort=id_desc');
    die;
}
